Love you the most mau. {{ $cognitoPoolName }}
...
@if (in_array($challengeNameValue, ['SOFTWARE_TOKEN_MFA', 'SMS_MFA', 'SMS_OTP', 'EMAIL_OTP', 'PASSWORD_VERIFIER', 'PASSWORD']))
    <x-cognito::challenge.password />
@endif
@endPush

@push('cognito-challenge-scripts')
    ...
    <script>
        ...
        const AUTH_CSRF_TOKEN = '{{ $csrfToken }}';
